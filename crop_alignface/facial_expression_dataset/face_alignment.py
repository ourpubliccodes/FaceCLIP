...
def image_align(src_file, dst_file, face_landmarks, output_size=1024, transform_size=4096, enable_padding=True):
        # Align function from facial dataset pre-processing step
        ...
        eye_to_eye   = eye_right - eye_left   # x'
        mouth_left   = lm_mouth_outer[0]
        mouth_right  = lm_mouth_outer[6]
        mouth_avg    = (mouth_left + mouth_right) * 0.5
        eye_to_mouth = mouth_avg - eye_avg    # y'
        ...
        if enable_padding and max(pad) > border - 4:
            ...
            try:
                ...
                print("error: ", dst_file)
                open("./data/affectnet/error_align.txt", "a").write(dst_file + "\n")
                flag = 0
            if flag:
                h, w, _ = img.shape
